...
<head>
    ...
    <title>Create Account - Lumina Marketplace</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div style="text-align: center; margin-bottom: 3rem;">
                ...
                <h2 style="margin-top: 1.5rem; font-weight: 900; letter-spacing: -0.02em; background: var(--primary-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Join the Elite</h2>
                <p style="color: var(--text-muted); margin-top: 0.5rem;">Access premium assets and developer tools.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    @error('name') <span class="error-message"><i class="fas fa-exclamation-circle"></i> {{ $message }}</span> @enderror
                </div>
